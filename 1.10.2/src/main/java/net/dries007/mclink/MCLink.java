...
public class MCLink extends MCLinkCommon
{
    ...
    public void connectEvent(FMLNetworkEvent.ServerConnectionFromClientEvent event)
    {
        ...
        EntityPlayerMP p = ((NetHandlerPlayServer) event.getHandler()).playerEntity;
    ...
    protected void authCompleteAsync(IPlayer player, String msg, UUID name, ImmutableCollection<Authentication> authentications, Marker authresult)
    {
        ...
        server.addScheduledTask(() -> {
            ...
            if (p != null) p.connection.disconnect(msg); // The player may have disconnected before this could happen.
        });
    }
